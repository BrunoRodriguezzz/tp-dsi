...
import ar.edu.utn.frba.dds.client.exceptions.NotFoundException;
import ar.edu.utn.frba.dds.client.dtos.AuthResponseDTO;
import ar.edu.utn.frba.dds.client.dtos.auth.RefreshRequestDTO;
...
public class WebApiCallerService {
  ...
  public WebApiCallerService(@Value("${servicio.apiGateway}") String gatewayURL) {
    this.webClient = WebClient.builder().build();
    this.authServiceUrl = gatewayURL + "/auth";
  }
